...
namespace Vulkan
{
   ...
   public static partial class VK
   {
      ...
      public delegate Result CreateAccelerationStructureNVDelegate(Device device, ref AccelerationStructureCreateInfoNV pCreateInfo, AllocationCallbacks pAllocator, ref AccelerationStructureNV pAccelerationStructure);
      public delegate void DestroyAccelerationStructureNVDelegate(Device device, AccelerationStructureNV accelerationStructure, AllocationCallbacks pAllocator);
      ...
      public delegate Result CreateRayTracingPipelinesNVDelegate(Device device, PipelineCache pipelineCache, UInt32 createInfoCount, ref RayTracingPipelineCreateInfoNV pCreateInfos, AllocationCallbacks pAllocator, ref Pipeline pPipelines);
