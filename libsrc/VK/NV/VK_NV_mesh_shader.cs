...
namespace Vulkan
{
   ...
   public static partial class VK
   {
      ...
      public delegate void CmdDrawMeshTasksNVDelegate(CommandBuffer commandBuffer, UInt32 taskCount, UInt32 firstTasks);
      public delegate void CmdDrawMeshTasksIndirectNVDelegate(CommandBuffer commandBuffer, Buffer buffer, DeviceSize offset, UInt32 drawCount, UInt32 strides);
      public delegate void CmdDrawMeshTasksIndirectCountNVDelegate(CommandBuffer commandBuffer, Buffer buffer, DeviceSize offset, Buffer countBuffer, DeviceSize countBufferOffset, UInt32 maxDrawCount, UInt32 strides);
