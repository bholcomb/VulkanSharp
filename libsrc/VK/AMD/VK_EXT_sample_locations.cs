...
namespace Vulkan
{
   ...
   public static partial class VK
   {
      ...
      public delegate void CmdSetSampleLocationsEXTDelegate(CommandBuffer commandBuffer, ref SampleLocationsInfoEXT pSampleLocationsInfos);
      public delegate void GetPhysicalDeviceMultisamplePropertiesEXTDelegate(PhysicalDevice physicalDevice, SampleCountFlags samples, ref MultisamplePropertiesEXT pMultisamplePropertiess);
