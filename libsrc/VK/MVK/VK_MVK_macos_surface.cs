...
namespace Vulkan
{
   ...
   public static partial class VK
   {
      ...
      public delegate Result CreateMacOSSurfaceMVKDelegate(Instance instance, ref MacOSSurfaceCreateInfoMVK pCreateInfo, ref AllocationCallbacks pAllocator, ref SurfaceKHR pSurfaces);
